	   ...
	   ResultSet rs,rs1;
           ...
           String time_slot="",date="";
			...
			st=con.createStatement();
                        rs=st.executeQuery("select seatno from bookedseat where audino='Audi2' and timeslot='"+time_slot+"' and date='"+date+"'");
		while(rs.next()){
            ...
            catch(Exception e)
		{
                ...
                rs1=st1.executeQuery("Select * from moviesdetail where title=(select name from nowshowing where audi='Audi2')");
...
<table>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="J<%=i%>" onClick="sendInfo('J<%=i%>')"></td>
                 <%
                 }
                else{
                %>
            ...
            <tr>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="D<%=i%>" value="<%=i%>" id="D<%=i%>" onClick="sendInfo('D<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="C<%=i%>" value="<%=i%>" id="C<%=i%>" onClick="sendInfo('C<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="B<%=i%>" value="<%=i%>" id="B<%=i%>" onClick="sendInfo('B<%=i%>')"></td>
                 <%
                 }
                else{
                %>
         ...
         <form method="post">
             ...
             <%
                 if(request.getParameter("Book")!=null)
                 {
                     ...
                     for(int i=0;i<l;i++)
                     {  myst.executeUpdate("insert into bookedseat values('"+date+"','Audi2','"+time_slot+"','"+seatno[i]+"','"+id+"')");
