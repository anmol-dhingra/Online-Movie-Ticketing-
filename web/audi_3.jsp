	   ...
	   ResultSet rs,rs1;
           ...
           String time_slot="",date="";
			...
			st=con.createStatement();
                        rs=st.executeQuery("select seatno from bookedseat where audino='Audi3' and timeslot='"+time_slot+"' and date='"+date+"'");
		while(rs.next()){
            ...
            catch(Exception e)
		{
                ...
                rs1=st1.executeQuery("Select * from moviesdetail where title=(select name from nowshowing where audi='Audi3')");
...
<table>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="J<%=i%>" onClick="sendInfo('J<%=i%>');seatInfo('J<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="I<%=i%>" onClick="sendInfo('I<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="H<%=i%>" onClick="sendInfo('K<%=i%>')"></td>
                 <%
                 }
                else{
                %>
                    <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-default" name="comment" value="<%=i%>" id="H<%=i%>" onClick="setColor('K<%=i%>');seatInfo('K<%=i%>');print(); sendInfo('K<%=i%>');"></td>
                 <%
                    }
                 } 
                 %>   
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="H<%=i%>" onClick="sendInfo('H<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="G<%=i%>" onClick="sendInfo('G<%=i%>')"></td>
                 <%
                 }
                else{
                %>
            ...
            <tr>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="F<%=i%>" onClick="sendInfo('F<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="E<%=i%>" onClick="sendInfo('E<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="D<%=i%>" onClick="sendInfo('D<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="C<%=i%>" onClick="sendInfo('C<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="B<%=i%>" onClick="sendInfo('B<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="A<%=i%>" onClick="sendInfo('A<%=i%>')"></td>
                 <%
                 }
                else{
                %>
       ...
       <div class="panel-heading"><h3><%out.print("Movie:  "+moviename+"("+rating+")");%></h3><h3><%out.print("Movie Time:  "+time_slot);%></h3></div>
         ...
         <div class="panel-body"><br><div id="myShow"></div><br><br><br><br><br><br><br></div>
              ...
              <%
                 if(request.getParameter("Book")!=null)
                 {
                     ...
                     String[] seatno=seat.split(",");
                      String id=(String)mySession.getAttribute("loginid");
                     int l=seatno.length;
                     Statement myst;
                     myst=con.createStatement();
                     for(int i=0;i<l;i++)
                     {
                        myst.executeUpdate("insert into bookedseat values('"+date+"','Audi3','"+time_slot+"','"+seatno[i]+"','"+id+"')");
                     }
                     ...
                     {
                       %><script>alert("Regret!! Seat has been booked by someone just now :( Select another one")
                             </script><%
                     }
                };
             %>
