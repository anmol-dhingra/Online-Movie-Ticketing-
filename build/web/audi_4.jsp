	   ...
	   ResultSet rs,rs1;
           ...
           String time_slot="",date="";
			...
			st=con.createStatement();
                        rs=st.executeQuery("select seatno from bookedseat where audino='Audi4' and timeslot='"+time_slot+"' and date='"+date+"'");
		while(rs.next()){
            ...
            catch(Exception e)
		{
                ...
                rs1=st1.executeQuery("Select * from moviesdetail where title=(select name from nowshowing where audi='Audi4')");
...
<table>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="I<%=i%>" onClick="sendInfo('I<%=i%>');seatInfo('I<%=i%>')"></td>
                 <%
                 }
                else{
                %>
             ...
             <%
                 ...
                 {
                     %>
                     <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-danger disabled" name="comment" value="<%=i%>" id="K<%=i%>" onClick="sendInfo('H<%=i%>')"></td>
                 <%
                 }
                else{
                %>
                    <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn btn-default" name="comment" value="<%=i%>" id="K<%=i%>" onClick="setColor('H<%=i%>');seatInfo('H<%=i%>');print(); sendInfo('H<%=i%>');"></td>
                 <%
                    }
                 } 
                 %>   
            ...
            <tr>
             ...
             <tr><td colspan="20" align="center"><h4><strong>Screen This Way</strong></h4></td></tr>
                <tr><td><button class="btn btn-success">Entry</button></td><td></td><td colspan="14"><hr style="color:yellow;background-color:#4169E1;height: 3px;width:100%"></td><td></td><td><button class="btn btn-danger">Exit</button></td></tr>
           </table>
                <br/> 
         ...
         <div class="panel-footer">
             ...
             <%
                 if(request.getParameter("Book")!=null)
                 {
                     ...
                     for(int i=0;i<l;i++)
                     {
                         myst.executeUpdate("insert into bookedseat values('"+date+"','Audi4','"+time_slot+"','"+seatno[i]+"','"+id+"')");
                        }
